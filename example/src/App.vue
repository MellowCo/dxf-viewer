    ...
    <q-layout view="hHh lpr fff" data-nosnippet>
            ...
            <q-toolbar>
                <q-toolbar-title :shrink="true">
                    ...
                    <a href="https://www.npmjs.com/package/dxf-viewer">
                        <q-badge align="top" color="secondary"></q-badge>
                    </a>
                </q-toolbar-title>

                <q-file color="white" label-color="white" filled bottom-slots clearable dense :value="inputFile"
                    label="Select file or drag here" style="max-width: 300px;" accept=".dxf" class="q-ml-xl" dark
                ...
                <q-space />
                <q-btn icon="fab fa-github" color="primary" label="dxf-viewer on GitHub" no-caps class="q-mx-sm github"
                    type="a" href="https://github.com/vagran/dxf-viewer" />
                <q-btn icon="fab fa-github" color="primary" label="This example on GitHub" no-caps
                    class="q-mx-sm github" type="a" href="https://github.com/vagran/dxf-viewer-example-src" />
            </q-toolbar>
        </q-header>
        <q-page-container>
            <ViewerPage :dxfUrl="dxfUrl">
                <div v-if="inputFile === null" class="centralUploader row justify-center items-center">
                    <div class="col-auto" style="width: 300px;">
                        <q-file filled bottom-slots clearable :value="inputFile" label="Select file or drag here"
                            accept=".dxf" class="col" @input="_OnFileSelected" @clear="_OnFileCleared">
                            <template v-slot:before>
        ...
        <q-dialog v-model="urlDialog">
            <q-card>
                ...
                <q-card-section>
                    <div class="q-mb-lg">
                        <a href="https://startpage.com/sp/search?q=SECTION%20HEADER%20filetype:dxf" target="_blank">Find
                            some
                            examples</a>
                    </div>
